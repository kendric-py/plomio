...
from apps.api.src.config import config as app_config
...
from packages.worker_health.src.models import WorkerHeartbeatLog  # noqa: F401
...
config.set_main_option('sqlalchemy.url', str(app_config.POSTGRES.DSN))
