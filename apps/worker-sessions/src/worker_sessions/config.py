...
class SessionsStreamConfig(BaseSettings):
    ...
    instance don't collide with session data. See apps/worker-sessions/AGENTS.md."""
...
class LivenessConfig(BaseSettings):
    ...
    apps/worker-sessions/AGENTS.md for the open questions around the receiving endpoint."""
